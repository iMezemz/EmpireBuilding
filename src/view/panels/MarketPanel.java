...
public class MarketPanel extends ImagePanel implements Pressable, CarriesCityName {
	...
	public MarketPanel (String currentLocation , ArrayList<EconomicBuilding> EconomicalBuildingsArray) {
		...
		upgradeButton.setActionCommand("upgrademarket");
		...
		buyButton.setActionCommand("buymarket");
		this.add(buyButton);
